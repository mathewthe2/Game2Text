#! /bin/sh
rm -rf build, dist
python -m eel game2text.py web --windowed --icon "icon.icns" --add-data "logs/images/temp.png:logs/images" --add-data "logs/text:logs/text" --add-data "mac:mac" --add-data "config.ini:."
